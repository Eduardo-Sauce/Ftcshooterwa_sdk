...
@TeleOp(name="telebetter??", group="Linear OpMode")
public class fastershootertele extends LinearOpMode {
...
//            controllers.readInputs();
            ...
            if (currentGamepad2.triangle && !previousGamepad2.triangle) {  // Change to gamepad2 if that's what you need.
                shooter.setgecko(.95);
            ...
            if (currentGamepad2.left_bumper && !previousGamepad2.left_bumper) {  // Change to gamepad2 if that's what you need.
